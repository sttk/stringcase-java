...
public class StringCaseTest {
  ...
  class CamelCase {
    ...
    @Test
    void keepDigits() {
      var result = camelCase("abc123-456defG789HIJklMN12");
  ...
  @Nested
  class CamelCaseWithSep {
    @Test
    void fromCamelCase() {
      var result = camelCaseWithSep("abcDefGHIjk", "_-");
      assertThat(result).isEqualTo("abcDefGhIjk");
    }
    ...
    @Test
    void fromSnakeCase() {
      var result = camelCaseWithSep("abc_def_ghi", "_");
      assertThat(result).isEqualTo("abcDefGhi");

      result = camelCaseWithSep("abc_def_ghi", "-");
      assertThat(result).isEqualTo("abc_Def_Ghi");
    }

    @Test
    void fromKebabCase() {
      var result = camelCaseWithSep("abc-def-ghi", "-");
      assertThat(result).isEqualTo("abcDefGhi");

      result = camelCaseWithSep("abc-def-ghi", "_");
    ...
    @Test
    void keepDigits() {
      var result = camelCaseWithSep("abc123-456defG789HIJklMN12", "_");
      assertThat(result).isEqualTo("abc123-456DefG789HiJklMn12");

      result = camelCaseWithSep("abc123-456defG789HIJklMN12", "-");
      assertThat(result).isEqualTo("abc123456DefG789HiJklMn12");
    }

    @Test
    void convertWhenStartingWithDigit() {
      var result = camelCaseWithSep("123abc456def", "-_");
      assertThat(result).isEqualTo("123Abc456Def");

      result = camelCaseWithSep("123ABC456DEF", "-_");
      assertThat(result).isEqualTo("123Abc456Def");
    }

    @Test
    void treatMarksAsSeparators() {
      var result = camelCaseWithSep(":.abc~!@def#$ghi%&jk(lm)no/?", ":@$&()/");
      assertThat(result).isEqualTo(".Abc~!Def#Ghi%JkLmNo?");
    }

    @Test
    void convertEmpty() {
      var result = camelCaseWithSep("", "-_");
      assertThat(result).isEqualTo("");
    }
  }

  @Nested
  class CamelCaseWithKeep {
    @Test
    void fromCamelCase() {
      var result = camelCaseWithKeep("abcDefGHIjk", "_-");
      assertThat(result).isEqualTo("abcDefGhIjk");
    }
    ...
    @Test
    void fromSnakeCase() {
      var result = camelCaseWithKeep("abc_def_ghi", "-");
      assertThat(result).isEqualTo("abcDefGhi");

      result = camelCaseWithKeep("abc_def_ghi", "_");
      assertThat(result).isEqualTo("abc_Def_Ghi");
    }

    @Test
    void fromKebabCase() {
      var result = camelCaseWithKeep("abc-def-ghi", "_");
      assertThat(result).isEqualTo("abcDefGhi");

      result = camelCaseWithKeep("abc-def-ghi", "-");
      assertThat(result).isEqualTo("abc-Def-Ghi");
    }
    ...
    @Test
    void keepDigits() {
      var result = camelCaseWithKeep("abc123-456defG789HIJklMN12", "-");
      assertThat(result).isEqualTo("abc123-456DefG789HiJklMn12");

      result = camelCaseWithKeep("abc123-456defG789HIJklMN12", "_");
      assertThat(result).isEqualTo("abc123456DefG789HiJklMn12");
    }

    @Test
    void convertWhenStartingWithDigit() {
      var result = camelCaseWithKeep("123abc456def", "_");
      assertThat(result).isEqualTo("123Abc456Def");

      result = camelCaseWithKeep("123ABC456DEF", "-");
      assertThat(result).isEqualTo("123Abc456Def");
    }

    @Test
    void treatMarksAsSeparators() {
      var result = camelCaseWithKeep(":.abc~!@def#$ghi%&jk(lm)no/?", ".~!#%?");
      assertThat(result).isEqualTo(".Abc~!Def#Ghi%JkLmNo?");
    }

    @Test
    void convertEmpty() {
      var result = camelCaseWithKeep("", "-_");
      assertThat(result).isEqualTo("");
    }
  }
